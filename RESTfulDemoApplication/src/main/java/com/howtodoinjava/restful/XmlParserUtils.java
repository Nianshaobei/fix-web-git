...
public class XmlParserUtils {
    ...
    private static Map<Integer, FixTagTranslator> xmlParser(String resource) throws SAXException, DocumentException {
        Map<Integer, FixTagTranslator> map = new HashMap<>();
    ...
    static Map<Integer, FixTagTranslator> loadBuiltinTranslators(String resource) throws SAXException, DocumentException {
